/**
 * @file SignCategoriesController.js
 * @description Controller điều phối yêu cầu HTTP API liên quan đến SignCategories.
 * @module Backend
 */
...
/**
 * Lớp SignCategoriesController
 * Controller điều phối yêu cầu HTTP API liên quan đến SignCategories.
 */
