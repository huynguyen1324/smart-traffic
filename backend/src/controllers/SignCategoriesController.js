...
class SignCategoriesController {
    ...
    async create(req, res) {
        try {
            const id = await signCategoriesService.create(req.body);
    ...
    async update(req, res) {
        try {
            const updated = await signCategoriesService.update(req.params.id, req.body);
    ...
    async delete(req, res) {
        try {
            const deleted = await signCategoriesService.delete(req.params.id);
